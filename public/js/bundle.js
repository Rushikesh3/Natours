      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Logged in successfully', 4);
            console.log();
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', _context.t0.response.data.message, 4);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Error loggging out! Try again.');
        case 12:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urll = type === 'password' ? 'updatePassword' : 'updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "api/v1/users/".concat(urll),
            data: data
            //   data: {
            //     name,
            //     email,
        ...
        case 4:
          ...
          if (status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Updated successfully"), 4);
          }
          _context.next = 13;
          break;
        case 10:
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicnVzaGlrZXNoNjQ2OTEiLCJhIjoiY2xtOXl0MjExMG15ZTNndGZudHN6MXVmNyJ9.3o_f6cmEVgsotsdkKlhjYQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/rushikesh64691/clm9ywzqp015801nzcvp68dp2',
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Created in successfully', 1);
            window.setTimeout(function () {
              location.assign('/');
            }, 700);
          }
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](1);
          (0, _alert.showAlert)('error', _context.t0.response.data.message, 1);
        case 11:
        case "end":
          return _context.stop();
      }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51N2lEGSEI5rPsxWQEzBElxSgDj7EUuGBL2AJbXyX8KMhDuZUe2Qk1O5699zuJEoZrttQud7lbQojH6eZOOTlI1Oq003m60IdOf');
...
var signup_elm = document.querySelector('.form1');
